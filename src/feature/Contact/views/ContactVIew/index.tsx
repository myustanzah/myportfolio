...
export function ContactForm() {
  ...
  const [payload, setPayload] = useState<ContactFormProps.FormData>({fName: "", lName: "", email: "", interested: "A", msg: ""});
  const [errors, setErrors] = useState<ContactFormProps.ErrorProps>({});
  ...
  return (
    <section id="section-contact" className="dark:bg-black px-8 py-16">
      <div className="container mx-auto mb-20 text-center">
        <Typography variant="h1" className="dark:text-white mb-4">
          Contact Me
        </Typography>
        <Typography
          variant="lead"
